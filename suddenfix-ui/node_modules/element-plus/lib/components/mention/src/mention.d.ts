...
declare const mentionProps: {
  ...
  checkIsWhole: {
    readonly type: vue.PropType<(pattern: string, prefix: string) => boolean>;
...
//#endregion
export { MentionEmits, MentionInstance, MentionOptionProps, MentionProps, MentionPropsPublic, mentionDefaultProps, mentionEmits, mentionProps };