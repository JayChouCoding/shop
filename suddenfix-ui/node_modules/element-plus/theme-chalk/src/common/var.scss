...
$anchor: map.merge(
  (
    ...
    'hover-color': getCssVar('text-color-regular'),
...
$popper: map.merge(
  (
    ...
    'bg-color-light': getCssVar('bg-color', 'overlay'),
    'bg-color-dark': getCssVar('text-color', 'primary'),
  ),
  $popper
);
...
$upload: map.merge(
  (
    'dragger-padding-horizontal': 10px,
    'dragger-padding-vertical': 40px,
